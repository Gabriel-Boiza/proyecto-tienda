...
{
    protected $fillable = [
        'nombre', 'precio', 'descripcion', 'stock', 'imagen_principal', 'descuento', 'personalizable', 'fk_marca', 'codigo_producto'
    ];
    ...
    {
        return $this->belongsToMany(Cliente::class, 'carritos', 'producto_id', 'cliente_id')
                    ->withPivot('cantidad');
    }
}
