        ...
        <div class="producto bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:-translate-y-2 transition-transform duration-300 border border-gray-700/50 min-h-[400px] flex flex-col" data-producto-id="{{$producto->id}}">
            <div class="relative">
                ...
                <div class="absolute top-3 right-3 flex gap-2">
                    <button aria-label="añadir-favoritos" value='{{$producto}}' class="favoritos p-2 bg-gray-900/70 backdrop-blur-sm rounded-full hover:bg-gray-900 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                        </svg>
                    </button>
                    <button value='{{$producto}}' aria-label="añadir-carrito"  class="carrito p-2 bg-gray-900/70 backdrop-blur-sm rounded-full hover:bg-gray-900 transition-colors">
