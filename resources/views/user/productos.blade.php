        ...
        <div class="flex gap-8">
            ...
            <section class="flex-1">
                        ...
                        <article class="bg-gray-800/30 rounded-lg overflow-hidden">
                            <div class="relative">
                                ...
                                @if($producto->es_nuevo)
                                    <span class="absolute top-2 left-2 px-2 py-1 rounded text-sm bg-blue-500">
                                        Nuevo
                                    </span>
                                @endif
                            </div>
                ...
                <div class="flex justify-center mt-8 space-x-2">
                    <button class="w-8 h-8 flex items-center justify-center rounded-lg bg-purple-600 text-white">1</button>
                    <button class="w-8 h-8 flex items-center justify-center rounded-lg bg-gray-700 text-white hover:bg-gray-600">2</button>
                    <button class="w-8 h-8 flex items-center justify-center rounded-lg bg-gray-700 text-white hover:bg-gray-600">3</button>
                </div>
            </section>
        </div>
    </div>
