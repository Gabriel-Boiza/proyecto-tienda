        ...
        <main class="flex-1 p-8 flex flex-col h-full">
            ...
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-400 mb-2">Imágenes Adicionales (máximo 4)</label>
                        <div class="flex items-center justify-center w-full">
                            <label class="flex flex-col w-full h-32 border-2 border-dashed border-zinc-700 rounded-md hover:bg-zinc-800 cursor-pointer">
                                <div class="flex flex-col items-center justify-center pt-7">
                                    <svg class="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <input type="file" name="imagenes_adicionales[]" class="opacity-0" accept="image/*" multiple/>
                            </label>
                        </div>
                    </div>
                </div>
