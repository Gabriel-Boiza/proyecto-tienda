...
<div class="flex-1 p-6">
    <div class="mb-6">
        <h1 class="text-xl font-bold">Crear Nuevo Cupón</h1>
        <p class="text-gray-400">Complete el formulario para crear un nuevo cupón de descuento</p>
    </div>
    
    <div class="bg-zinc-800/50 rounded-lg p-6">
        <form action="{{ route('cupones.store') }}" method="POST" class="space-y-6">
            @csrf
