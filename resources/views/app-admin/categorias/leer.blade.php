    ...
    <form method="POST" id="formulario" class="flex flex-col md:flex-row justify-center w-full md:max-w-[60%] mb-2">
        ...
        <div class="w-full mb-2 md:mb-0">
            <input
                ...
                aria-label="Nombre de la nueva categoría" {{-- Added aria-label --}}
            >
        ...
        <input
            ...
            value="+ Generar"
            aria-label="Crear nueva categoría" {{-- Added aria-label --}}
        >
    </form>

    <div id="container" class="admin-container w-full md:w-[60%]">
